...
public class MyArgumentCompleter
    implements Completer
{
    ...
    public MyArgumentCompleter(final ArgumentDelimiter delimiter, final Collection<Completer> completers) {
        this.delimiter = checkNotNull(delimiter);
        checkNotNull(completers);
        this.completers.addAll(completers);
    }

    public MyArgumentCompleter(final ArgumentDelimiter delimiter, final Completer... completers) {
        this(delimiter, Arrays.asList(completers));
    }

    public MyArgumentCompleter(final Completer... completers) {
        this(new WhitespaceArgumentDelimiter(), completers);
    }

    public MyArgumentCompleter(final List<Completer> completers) {
        this(new WhitespaceArgumentDelimiter(), completers);
    }
    ...
    /**
     * The {@link MyArgumentCompleter.ArgumentDelimiter} allows custom breaking up of a {@link String} into individual
    ...
    /**
     * {@link MyArgumentCompleter.ArgumentDelimiter} implementation that counts all whitespace (as reported by
